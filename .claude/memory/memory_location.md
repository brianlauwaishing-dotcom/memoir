...
**規則**:此專案 memory 一律存 `E:\memoir\.claude\memory\`(專案內),不放 `C:\Users\potato\.claude\projects\E--memoir\memory\`(電腦根目錄)。
...
**How to apply**:
- 寫新 memory:一律寫到 `E:\memoir\.claude\memory\<file>.md`
- 更新索引:同步更新 `E:\memoir\.claude\memory\MEMORY.md`
