...
private var _SavedFilled: ImageVector? = null

val UntitledIcons.SavedFilled: ImageVector
    get() {
        if (_SavedFilled != null) return _SavedFilled!!
        _SavedFilled = ImageVector.Builder(
            name = "SavedFilled",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
